...
using Util.BootStrap.Study.HtmlPackage.Builders.Nodes;
...
namespace Util.BootStrap.Study.HtmlPackage.Builders {
    ...
    public class AttributeBuilder {
        ...
        /// data-options属性生成器
        /// </summary>
        private JsonAttributeBuilder _dataOptionBuilder;

        /// <summary>
        /// 获取data-options属性生成器
        /// </summary>
        protected JsonAttributeBuilder GetDataOptionBuilder() {
            return _dataOptionBuilder ?? ( _dataOptionBuilder = new JsonAttributeBuilder() );
        }
        ...
        public void AddDataOption( string name, string value, bool isAddQuote = false ) {
            if ( value.IsEmpty() )
                return;
            GetDataOptionBuilder().Update( name, value, isAddQuote );
